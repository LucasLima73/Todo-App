    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1, width: '100%' }}>
        <View style={styles.main}>
          ...
          <Text style={styles.darkfield}>Nome:</Text>
          <Text style={styles.darktitle}>{userData.fullName}</Text>
          <Text style={styles.darkfield}>Email:</Text>
          <Text style={styles.darktitle}>{userData.email}</Text>
          ...
          <View style={styles.footerView}>
            <Text onPress={signOut} style={styles.footerLink}>Sair</Text>
          </View>
        </View>
      </ScrollView>
